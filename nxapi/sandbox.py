#!/usr/bin/env python
# Example script genmerated by the NX-OS Developer Sandbox
import requests
import json
...
payload=[
  {
    ...
    "method": "cli",
    "params": {
      "cmd": "configure terminal ; interface Ethernet1/1 ; description bbbbb",
      "version": 1
    },
    "id": 1
  }
